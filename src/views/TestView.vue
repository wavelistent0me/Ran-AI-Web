<template>
  <div class="body" ref="scrollRef">
    ...
    <div v-if="!conversationList.length" class="explain">
      ...
      <div class="expositoryCase">欢迎使用阴阳怪气小助手</div>
      <div class="consume">
        <!--<el-icon><Goods/></el-icon>-->
        <div class="consumeText">可以随便提问哦</div>
      </div>
    ...
    <div class="footer">
      <div class="footer-bar">
        ...
        <div class="clear2" v-show="store.getters.userinfo.type === 'ADMIN' && !aiLoading" @click="dialogueDisplay = true">
          <div style="padding-top: 4px">
            <el-icon size="13px" style="padding-right: 3px"><ChatDotRound/></el-icon>
          </div>
          <div>记忆回溯</div>
        </div>
  ...
  <el-dialog v-model="dialogueDisplay" title="" width="430px" center style="background-color: var(--bgColor1)">
    <div>
    ...
    function webSocket({messages, index}) {
      if (typeof WebSocket == "undefined") {
        ...
        socket.value = new WebSocket(process.env.VUE_APP_WSS + "/gpt-web/api/"
            + localStorage.getItem("token") + "/" + model.value + "/kebo");
        // TODO 建立连接
